...
export const metadata: Metadata = {
  title: "Fresh Market | Organic Groceries Delivered Daily",
  description: "Shop fresh organic groceries online with same-day delivery. Quality produce, dairy, and bakery items from trusted suppliers. 100% satisfaction guaranteed.",
  keywords: "grocery delivery, organic produce, fresh vegetables, online grocery shopping, same-day delivery",
  openGraph: {
    title: "Fresh Market | Organic Groceries Delivered Daily",
    description: "Shop fresh organic groceries online with same-day delivery. Quality produce, dairy, and bakery items.",
    type: "website",
    siteName: "Fresh Market"
  }
};
